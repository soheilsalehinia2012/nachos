...
#define syscallSemaphorGet	13
#define syscallSemaphoreV	14
#define syscallSemaphoreP	15
#define syscallLockGet 		16
#define syscallLockAcquire  17
#define syscallLockRelease	18
#define syscallConditionGet	 19
#define syscallConditionWake  	20
#define syscallConditionWakeAll  	21
#define syscallConditionSleep 	 22
...
int SemaphoreGet(int val);

int SemaphoreV(int sNum);

int SemaphoreP(int sNum);

int LockGet();

int LockAcquire(int lNum);

int LockRelease(int lNum);

int ConditionGet();

int ConditionWake(int cNum);

int ConditionWakeAll(int cNum);

int ConditionSleep(int cNum);
