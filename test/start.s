...
name:				; \
	...
	SYSCALLSTUB(SemaphoreGet, syscallSemaphorGet)
	SYSCALLSTUB(SemaphoreV, syscallSemaphoreV)
	SYSCALLSTUB(SemaphoreP, syscallSemaphoreP)
	SYSCALLSTUB(LockGet, syscallLockGet)
	SYSCALLSTUB(LockAcquire, syscallLockAcquire)
	SYSCALLSTUB(LockRelease, syscallLockRelease)
	SYSCALLSTUB(ConditionGet, syscallConditionGet)
	SYSCALLSTUB(ConditionWake, syscallConditionWake)
	SYSCALLSTUB(ConditionWakeAll, syscallConditionWakeAll)
	SYSCALLSTUB(ConditionSleep, syscallConditionSleep)
